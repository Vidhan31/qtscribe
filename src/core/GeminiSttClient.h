...
class GeminiSttClient : public AbstractSttClient {
    Q_OBJECT
    QML_ELEMENT
    QML_SINGLETON
...
private:
    ...
    inline static constexpr QStringView kApiEndpoint = u"https://generativelanguage.googleapis.com/v1beta/interactions";
};
